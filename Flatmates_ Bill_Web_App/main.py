...
class BillFormPage(MethodView):
    ...
    def post(self):
        ...
        flatmate1 = flat.Flatmates(billform.name1.data, float(billform.days_in_house1.data))
        flatmate2 = flat.Flatmates(billform.name2.data, float(billform.days_in_house2.data))
